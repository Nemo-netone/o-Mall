...
export const CHARITY = {
  ...
  farmers: [
    { name: "赵大伯", years: 5, area: "河南·南阳 · 30亩", story: "以前小麦一斤就卖个块把钱，心里总是没底。现在和一肽当先合作，技术有人教、价格有保底，今年多收了3000斤，娃儿的学费再也不愁了。" },
...
export const FUNCTIONS_PAGE = {
  ...
  brands: [
    { name: "一肽当先", fValue: 45.2, purity: 97, mw: "＜1000Da", primary: true },
...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "一肽当先系列产品采用专利酶解技术，实现F值≥45.3，显著优于行业水平，为肝脏细胞的修复提供精准营养支持。",
  ...
  },
  {
    ...
    content: [
      ...
      "一肽当先系列产品严格控制分子量在1000Da以内，并通过专利技术将F值提升至45.3以上，为人体提供最优质的护肝营养方案。",
    ],
  },
];
